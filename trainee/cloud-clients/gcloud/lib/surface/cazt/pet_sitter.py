...
"""Command for configuring a moggy impersonation role."""
...
class PetSitter(base.Command):
  """TODO - get Pete to write the documentation."""

  @staticmethod
  def Args(parser):
    parser.add_argument(
      '--arn',
      help='The full arn of the IAM role to use for impersonation.',
      required=True
      )
  ...
  def Run(self, args):
    ...
    API_ENDPOINT_PATH = "petSitter"  # no leading /
